...
import org.reactivecouchbase.webstack.WebsocketPing;
...
public class MyWebSocketActor extends UntypedActor {
    ...
    public void onReceive(Object message) throws Exception {
        ...
        if (message instanceof TextMessage) {
            JsValue value = Json.parse(((TextMessage) message).getStrictText());
            ...
            out.tell(TextMessage.create(response.stringify()), getSelf());
        } else {
            unhandled(message);
        }
    }
